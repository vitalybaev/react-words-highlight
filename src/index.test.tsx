...
describe('WordsHighlight', () => {
  ...
  it('renders with some query', () => {
    const { container } = render(<WordsHighlight text="Foo bar bar" query="bar" />);
  ...
  it('renders with some several words query', () => {
    const { container } = render(<WordsHighlight text="Foo bar bar" query="foo bar" />);
    const marks = container.querySelectorAll('mark');
  ...
  it('renders with custom tag and class name', () => {
    const { container } = render(
      <WordsHighlight text="Foo bar" query="bar" highlightTag="strong" highlightClassName="my-classname" />,
    );
    const marks = container.querySelectorAll('mark');
